...
init -1 python hide:
    ...
    config.window_title = u"SF-IO"
    
    config.window_icon = "sf-io-icon.png"
    ...
    #style.default.font = "game_over.ttf"

    ## The default size of text.

    #style.default.size = 50
    
    #style.default.color = "#8dd35f"
...
init -1 python hide:
    ...
    #check : http://www.renpy.org/doc/html/config.html
